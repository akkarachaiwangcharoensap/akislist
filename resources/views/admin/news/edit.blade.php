...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('css/admin/news/edit.css') }}">
...
<body>
	...
	<div class="container-fluid">
		<div class="col-lg-9 col-md-9 col-sm-9 offset-lg-3 offset-md-3 offset-sm-3 post section">
			...
			<div class="content">
				{{ Form::open(array('url' => route('admin.news.post.save', array('id' => $post->id)), 'class' => 'form-group')) }}
					<div class="title">
						{{ Form::label('title') }}
					...
					<div class="description">
						{{ Form::label('content') }}
						{{ Form::textarea('content', $post->content, array('placeholder' => 'content', 'id' => 'page-editor')) }}
					</div><!-- .description -->
					<div class="action">
